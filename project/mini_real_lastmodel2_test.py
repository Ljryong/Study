...
# 비디오 파일이 들어 있는 디렉토리 경로 설정
video_directory = 'D:/mini/'

# 디렉토리 내 모든 파일 목록 가져오기
video_files = os.listdir(video_directory)

# 디렉토리 내 모든 비디오 파일 경로 저장
video_paths = [os.path.join(video_directory, file) for file in video_files if file.endswith('.mp4')]  # 또는 다른 비디오 확장자로 변경
