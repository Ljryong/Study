...
for frames, labels in test_ds.take(10):
  print("labels : ",labels)
import os  
train_CLASSES = sorted(os.listdir("C:\\Users\\AIA\\Desktop\\ai\\AI_mini_project\\resource\\download_dir\\train"))
test_CLASSES = sorted(os.listdir("C:\\Users\\AIA\\Desktop\\ai\\AI_mini_project\\resource\\download_dir\\test"))
