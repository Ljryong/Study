...
from sklearn.datasets import load_diabetes , load_breast_cancer ,load_iris , load_digits
...
#  n_components 는 min( n_features , n_classes -1 ) 로 결정된다
#                       열의 갯수   ,  y의 아웃풋 값의 -1  
