...
model = make_pipeline(StandardScaler() , GridSearchCV(RandomForestClassifier(), parameters, cv=kfold ,verbose=1,refit=True,n_jobs= -1 ) )


model = make_pipeline(StandardScaler(), RandomForestClassifier())

pipe = Pipeline([('st' , StandardScaler()) , ('rf' , RandomForestClassifier() ) ])
