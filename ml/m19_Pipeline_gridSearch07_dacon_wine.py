...
model = make_pipeline(MinMaxScaler() , GridSearchCV(RandomForestClassifier(), parameters, cv=kfold ,verbose=1,refit=True,n_jobs= -1 ) )

pipe = Pipeline([('st' , MinMaxScaler()) , ('rf' , RandomForestClassifier() ) ])
...
# accuracy_score 0.6551515151515152
# 0.6551515151515152
# 시간 :  5.07


# accuracy_score 0.6509090909090909
# 0.6509090909090909
# 시간 :  8.62