...
n_splits = 5
kfold = StratifiedKFold(n_splits=n_splits , random_state= 777 , shuffle = True  )

#2
from xgboost import XGBClassifier

model = RandomizedSearchCV(XGBClassifier() , parameters , cv= kfold , n_jobs=22 , random_state= 777  )
