...
# ['mean radius' 'mean texture' 'mean perimeter' 'mean area'    4
#  'mean smoothness' 'mean compactness' 'mean concavity'        7
#  'mean concave points' 'mean symmetry' 'mean fractal dimension'   10
#  'radius error' 'texture error' 'perimeter error' 'area error'    14  
#  'smoothness error' 'compactness error' 'concavity error'         17  
#  'concave points error' 'symmetry error' 'fractal dimension error'    20
#  'worst radius' 'worst texture' 'worst perimeter' 'worst area'    24
#  'worst smoothness' 'worst compactness' 'worst concavity'         27
...
# DecisionTreeClassifier : [0.01716396 0.         0.         0.         0.00503366 0.01815419
#  0.         0.         0.04749283 0.         0.         0.
#  0.01058659 0.         0.01067849 0.         0.0963153  0.
#  0.         0.0261642  0.728114   0.02420558 0.01609121] 0.9181286549707602
# DecisionTreeClassifier result 0.9181286549707602
# RandomForestClassifier : [0.0155153  0.00662362 0.00843374 0.10979271 0.11008515 0.00586799
#  0.01585719 0.02529441 0.02957789 0.0050821  0.00560018 0.00539941
#  0.00469355 0.09825195 0.02062092 0.18115176 0.09678895 0.01523608
#  0.03010118 0.06380275 0.12289866 0.01153775 0.01178678] 0.9590643274853801
# RandomForestClassifier result 0.9590643274853801
# GradientBoostingClassifier : [5.19183698e-03 1.95424134e-03 1.76488298e-03 5.99865554e-03
#  2.74305011e-01 9.79313579e-03 2.57981867e-03 1.76436134e-03
#  4.66625740e-02 3.86061612e-03 2.49654810e-03 4.05699657e-03
#  1.56494989e-03 6.00601642e-03 2.29268516e-02 7.23981164e-02
#  6.11894932e-02 4.32461466e-03 5.30482618e-03 1.41209766e-02
#  4.48103957e-01 3.58006120e-03 5.14578368e-05] 0.9707602339181286
# GradientBoostingClassifier result 0.9707602339181286
# XGBClassifier : [0.00950377 0.0053396  0.00791664 0.03071941 0.2378193  0.00434259
#  0.00567661 0.00696894 0.02223728 0.01412554 0.00396089 0.00883862
#  0.03171175 0.11807495 0.01518735 0.0685559  0.02740392 0.00566338
#  0.01370517 0.02870271 0.32303566 0.0042204  0.00628965] 0.9649122807017544
# XGBClassifier result 0.9649122807017544