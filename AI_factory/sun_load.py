...
# hdf5 
# model = load_model('C:\dataset/train_output/checkpoint-unet-base_line-epoch_45.hdf5')
...
model.compile(optimizer = Adam(learning_rate= 0.01),
              ...
              metrics = ['accuracy'])
model.summary()
model.load_weights('C:\dataset/train_output/model_pretrained_attention_unet_base_line_final_weights2.h5')
