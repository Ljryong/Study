...
model.add(Dense(100,activation= 'softmax'))  #(None,10) 510
...
model.fit(x_train,y_train , epochs = 10000 , batch_size=300 , verbose=1 , validation_split= 0.2 , callbacks=[es, rlr] )
...
# Flatten
# loss =  5.139774322509766
# acc =  0.08340000361204147

# GlobalAveragePooling2D
# loss =  3.8443453311920166dlwj
# acc =  0.13570000231266022
