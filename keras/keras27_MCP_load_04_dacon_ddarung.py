...
# mcp = ModelCheckpoint(monitor='val_loss' , mode = 'min' , verbose= 1 , save_best_only=True , filepath= 'c:/_data/_save/MCP/keras26_MCP4.hdf5' )

# hist = model.fit(x_train,y_train, epochs= 1000000 ,batch_size= 10 , validation_split=0.2 , callbacks= [es,mcp])

model = load_model('c:/_data/_save/MCP/keras26_MCP4.hdf5')
