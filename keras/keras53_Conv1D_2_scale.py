...
from keras.layers import Dense , LSTM , SimpleRNN , Conv1D , Flatten
...
# Conv1D
# Epoch 2589: early stopping
# 1/1 [==============================] - 0s 67ms/step - loss: 8.7277e-12 - mse: 8.7277e-12
# 1/1 [==============================] - 0s 70ms/step
# loss [8.727651414075499e-12, 8.727651414075499e-12]
# 결과 [[80.]]
