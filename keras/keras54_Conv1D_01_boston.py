...
hist = model.fit(x_train,y_train, epochs = 1000 , batch_size= 1000 , validation_split=0.2 , callbacks = [ mcp] , verbose = 1 )
end_time = time.time()
...
# LSTM
# ============================== 1. 기본 출력 ===============================
# 시간 :  25.876619338989258
# 23.91803741455078
# R2 :  0.7486338257726781
# ==============================

# Conv1D
# ============================== 1. 기본 출력 ===============================
# 시간 :  20.69244647026062
# 26.094655990600586
# R2 :  0.7257586693588528
# ==============================
