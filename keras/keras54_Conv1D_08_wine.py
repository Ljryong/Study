...
model.fit(x_train,y_train,epochs = 1000 , batch_size = 1 , verbose = 1 , callbacks=[es,mcp],validation_split=0.2)
end_time = time.time()
...
# Cnn
# 결과 0.21555794775485992
# acc 0.9074074029922485
# accuracy :  0.9074074074074074
# 시간 : 6.569488525390625


# LSTM
# Epoch 75: early stopping
# 2/2 [==============================] - 0s 2ms/step - loss: 0.0769 - acc: 0.9630
# 2/2 [==============================] - 0s 2ms/step
# (54,) (54,)
# 결과 0.07693389803171158
# acc 0.9629629850387573
# [0 1 0 0 1 2 1 2 0 2 0 1 2 0 2 1 0 0 2 0 0 2 1 1 1 1 0 2 2 1 0 2 0 1 1 0 1
