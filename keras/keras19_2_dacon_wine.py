...
# train_lab = LabelEncoder()
# train_lab.fit(train_csv)
# train_label = train_lab.transform(train_csv)
# print(train_label)

# train_lab = train_label.reshape(-1,1)
# print(train_lab)

# test_lab = LabelEncoder()
# test_lab.fit(test_csv['type'])
# test_label = test_lab.transform(test_csv['type'])
# print(test_label)

# test_lab = test_label.reshape(-1,1)
# print(test_lab)
# #####################################################################
...
x_train , x_test , y_train , y_test = train_test_split(x,one_hot_y, test_size=0.3 , random_state= 4 , shuffle=True , stratify= y )
...
model.fit(x_train,y_train,epochs=1000000 ,batch_size = 20 , validation_split=0.2 , callbacks=[es], verbose= 1)
