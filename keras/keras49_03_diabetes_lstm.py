...
hist = model.fit(x_train,y_train,epochs = 1000 , batch_size = 5 , validation_split = 0.2 ,callbacks= [es,mcp] )
end_time = time.time()
#4 평가, 예측
...
# Cnn
# 0.2580537388637755
# [4532.533203125, 4532.533203125, 56.988365173339844]
