...
from keras.layers import Dense , Dropout , Input , Conv2D , Flatten , MaxPooling1D
...
x_train = x_train.values.reshape(456,4,2,1)
x_test = x_test.values.reshape(196,4,2,1)
test_csv = test_csv.values.reshape(116,4,2,1)
...
# 2-2
model = Sequential()
model.add(Conv2D(64,(2,2),input_shape = (4,2,1) , padding='same' , strides = 1 ))
