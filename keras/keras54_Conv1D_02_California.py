...
#2-2 
model = Sequential()
model.add(Conv1D(50,2,input_shape = (4,2)))
model.add(Conv1D(15,2))
model.add(Flatten())
model.add(Dense(20))
model.add(Dense(1))
...
# 194/194 [==============================] - 0s 567us/step - loss: 0.6883 - mse: 0.6883 - mae: 0.6227
# 194/194 [==============================] - 0s 526us/step
# [0.6883213520050049, 0.6883213520050049, 0.6227090358734131]
# 0.4837214997933429
# 시간 : 18.932984828948975
