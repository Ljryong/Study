...
print(x_train.shape)  # (3847, 12)
print(x_test.shape)   # (1650, 12)
print(test_csv.shape) # (1000, 12)

x_train = x_train.values.reshape(3847,4,3)
x_test = x_test.values.reshape(-1,4,3)
test_csv = test_csv.values.reshape(-1,4,3)
...
# Cnn
# [1.0969880819320679, 0.5133333206176758]
# Acc =  0.5133333333333333
# 시간 : 25.92153573036194


# LSTM
# Epoch 1000: val_loss did not improve from 1.10844
# 1/1 [==============================] - 0s 21ms/step - loss: 1.0236 - acc: 0.5619 - val_loss: 1.1092 - val_acc: 0.5351
# 52/52 [==============================] - 0s 2ms/step - loss: 1.0370 - acc: 0.5430
# 52/52 [==============================] - 0s 1ms/step
# 32/32 [==============================] - 0s 982us/step
# [1.0369622707366943, 0.543030321598053]
