...
mcp = ModelCheckpoint(monitor='val_loss' , mode= 'min' , verbose= 1 , save_best_only = True , filepath = '../_data/_save/MCP/keras25_MCP3.hdf5' ) # mcp 모델만 mcp 에 넣음
...
model2 = load_model('../_data/_save/keras25_3_save_model.h5')       # 모델을 2개 돌릴 수 있다.
...
model3 = load_model('../_data/_save/MCP/keras25_MCP3.hdf5')       # 모델을 2개 돌릴 수 있다.
