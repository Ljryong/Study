...
#2 모델구성
model = Sequential()
model.add(GRU(128,activation='relu',input_shape = (3,1)))
# bidirectional 에는 activation 이 안들어가서 lstm 혹은 simplernn 안에 넣어줘야 한다.
...
# Bidirectional
# Epoch 1450: early stopping
# 1/1 [==============================] - 0s 153ms/step - loss: 1.9097e-05 - mse: 1.9097e-05
# 1/1 [==============================] - 0s 136ms/step
# loss [1.9097093172604218e-05, 1.9097093172604218e-05]
# 결과 [[80.452034]]

# Epoch 992: early stopping
# 1/1 [==============================] - 0s 154ms/step - loss: 7.6363e-05 - mse: 7.6363e-05
# 1/1 [==============================] - 0s 143ms/step
# loss [7.636257942067459e-05, 7.636257942067459e-05]
# 결과 [[79.90527]]



# Epoch 702: early stopping
# 1/1 [==============================] - 0s 118ms/step - loss: 7.4628e-06 - mse: 7.4628e-06
# 1/1 [==============================] - 0s 99ms/step
# loss [7.4628010224842e-06, 7.4628010224842e-06]
# 결과 [[80.871056]]
