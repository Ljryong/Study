...
# model.save_weights('../_data/_save/keras25_save_weights1.h5')
model.load_weights("../_data/_save/keras25_save_weights2.h5")       # weights에는 모델이 저장되지 않고 제일 마지막 weights 만 저장된다.
                                                                    # 사용하려면 모델을 만들거나 따로 모델을 가져와야된다.
...
# model.save_weights("../_data/_save/keras25_save_weights2.h5")
# model.load_weights("../_data/_save/keras25_save_weights2.h5")
