...
from tensorflow.python.keras.layers import Dense , Conv2D       # Conv2D = 2차원이미지 



model = Sequential()
# model.add(Dense(10, input_shape=(3,)))      # 인풋은 (n,3)
model.add(Conv2D(10,(2,2),input_shape = (10,10,1)))         # (2,2)는 자르는 크기 // 1은 흑백 , 3이 컬러 // (10,10,1) == 가로, 세로 10씩의 흑백 사진
model.add(Dense(5))
model.add(Dense(1))
