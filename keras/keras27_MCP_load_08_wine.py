...
# mcp = ModelCheckpoint(monitor='val_loss', mode='min' , verbose=1, save_best_only=True , filepath=  'c:/_data/_save/MCP/keras26_MCP8.hdf5'   )

# model.fit(x_train,y_train,epochs = 1000000 , batch_size = 1 , verbose = 1 , callbacks=[es,mcp],validation_split=0.2)

model = load_model('c:/_data/_save/MCP/keras26_MCP8.hdf5')
