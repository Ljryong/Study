...
from keras.layers import Dense , SimpleRNN ,Dropout , Bidirectional
...
#2 모델구성
model = Sequential()
model.add(Bidirectional(SimpleRNN(units = 10,), input_shape = (3,1)))       # 보조적인 놈, Bidirectional은 혼자 쓰지 못하고 안데 하나가 있어야함
                                                                            # simpleRNN 바깥에 ()를 해줘야한다.
