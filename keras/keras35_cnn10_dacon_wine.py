...
x_train = x_train.values.reshape(3847,4,3,1)
x_test = x_test.values.reshape(-1,4,3,1)
test_csv = test_csv.values.reshape(-1,4,3,1)
...
# 2-2
model = Sequential()
model.add(Conv2D(128,(2,2),input_shape = (4,3,1)))
model.add(Flatten())
model.add(Dense(12))
model.add(Dense(64))
model.add(Dense(7,activation = 'softmax'))
