...
mgd6 = Dense(8,activation='swish')(mgd5)
mgd7 = Dense(64,activation='swish')(mgd6)
mgd8 = Dense(16,activation='swish')(mgd7)
mgd9 = Dense(32,activation='swish')(mgd8)
mgd10 = Dense(32,activation='swish')(mgd9)
...
model.fit([x1_train,x2_train],[y1_train,y2_train] ,epochs= 10000000 , batch_size= 100 , validation_split=0.2 , callbacks=[es], verbose=2 )
