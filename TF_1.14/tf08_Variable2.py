...
""" 
# 2. Session / 변수.eval(sessiong=sess)
"""
...
with tf.compat.v1.Session() as sess :
    ...
    # placeholder에 넣어서 하는 방식 
    y_predict = x_test * w_val + b_val
    print('[6,7,8]의 예측 : ' , y_predict.eval(session = sess , feed_dict = {x_test : x_pred_data } ) )     # model.predict 하는 법
...
# placeholder에 넣어서 하는 방식 
y_predict = x_test * w_val + b_val
print('[6,7,8]의 예측 : ' , y_predict.eval(feed_dict = {x_test : x_pred_data } ) )     # model.predict 하는 법
