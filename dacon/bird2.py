...
# train['img_path'].values= np.array(train['img_path'].values)
# train['label'].values   = np.array(train['label'].values)
# val['img_path'].values  = np.array(val['img_path'].values)
# val['label'].values     = np.array(val['label'].values)
